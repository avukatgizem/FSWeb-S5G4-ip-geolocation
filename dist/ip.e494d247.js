...
ipAdresimiAl();
var url = "https://apis.ergineer.com/ipgeoapi/".concat(benimIP);
...
function createCard(info) {
  ...
  country.textContent = "\xDClke Bilgisi: (".concat(info.countryCode, ")");
  var location = document.createElement("p");
  location.textContent = "Enlem: ".concat(info.latitude, " Boylam: ").concat(info.longitude);
  var city = document.createElement("p");
  city.textContent = "\u015Eehir: ".concat(info.city);
  var timezone = document.createElement("p");
  timezone.textContent = "Saat Dilimi: ".concat(info.timezone);
  var currency = document.createElement("p");
  currency.textContent = "Para Birimi: ".concat(info.currency);
